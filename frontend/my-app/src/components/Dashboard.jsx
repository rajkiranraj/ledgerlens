...
export default function Dashboard({
  ...
  const [aiInsightsLastFetched, setAiInsightsLastFetched] = useState(null);
  ...
  // Spotlight refs for dashboard panels
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
      ...
      <div
        ref={headerRef}
        className="glass-panel header-bar spotlight-card"
        onMouseMove={(e) => handleSpotlight(e, headerRef.current)}
      >
        <div>
          <h1
            style={{
        ...
        <div style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
          ...
          <button className="btn btn-primary" onClick={onTriggerImport}>
      ...
      <div className="dashboard-grid">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
          ...
          >
            ...
            >
              <PlusCircle size={18} /> Add Shared Expense
            </button>
            <button
              className="btn btn-secondary"
              onClick={() => setShowSettlementModal(true)}
            >
              <Wallet size={18} /> Record Settlement Payment
            </button>
          </div>
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                {balances[selectedLedgerMember] >= 0
                  ? ` +₹${(balances[selectedLedgerMember] || 0).toFixed(2)}`
                  : ` -₹${Math.abs(balances[selectedLedgerMember] || 0).toFixed(2)}`}
              </strong>
            </p>
            ...
            <div className="table-wrapper" style={{ maxHeight: '450px' }}>
              <table>
                ...
                <tbody>
                  ...
                  {(!ledgers[selectedLedgerMember] ||
                    ledgers[selectedLedgerMember].length === 0) && (
                    <tr>
                      <td
                        colSpan="5"
                        style={{
